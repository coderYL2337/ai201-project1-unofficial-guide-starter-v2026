...
```
You can declare the pass/fail option as late as week eight. (Source: admin_pass_fail_option.txt)
```
...
```
You can declare the pass/fail option as late as week eight, after you have seen your midterm. 
...
- Sources retrieved: course_cs_210.txt, course_cs_210_exams.txt, course_cs_340.txt, course_cs_340_exams.txt, course_math_220.txt
